				...
				<div class="form-group col-md-4">
					<div class="avatarDiv">
						<div id="previewAvatar">
							<img src="../assets/images/defaultAvatar.jpg" alt="Avatar" class="rounded-circle img-fluid" width="100" height="100">
						</div>
			...
			createUser() {
				...
				axios.post(process.env.VUE_APP_BASE_URL + process.env.VUE_APP_SERVER_PORT + "/createUser", formData).then(response => {
					if(response.data.created) {
						...
						document.getElementById("previewAvatar").innerHTML = "<img src='" + require("../assets/images/defaultAvatar.jpg") + "' alt='Avatar' class='rounded-circle img-fluid' width='100' height='100'>";
						this.alreadyExists = "";
