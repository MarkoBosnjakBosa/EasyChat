                 ...
                 <table class="table">
                    ...
                    <tbody>
                        <tr v-for="(user, index) in users" :key="user._id">
                            ...
                            <td><img :src="renderAvatar(user.avatar)" alt="Avatar" class="rounded-circle" width="100" height="100"></td>
                            <td>{{user.username}}</td>
                            <td>{{user.email}}</td>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            deleteUser(username) {
                axios.delete(process.env.VUE_APP_BASE_URL + process.env.VUE_APP_PORT + "/deleteUser/" + username).then(response => {
